<x-app-layout>
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <a href="{{ $chapter ? route('instructor.courses.show', $chapter->course_id) : route('instructor.exams.index') }}" 
                ...
                @if($chapter)
                    <p class="text-gray-600">Untuk: {{ $chapter->course->title }} - {{ $chapter->title }}</p>
                @endif
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                <form action="{{ route('instructor.exams.store') }}" method="POST">
                    ...
                    <!-- Course Selection (if not from chapter) -->
                    @if(!$chapter)
                        <div class="mb-6">
                    ...
                    <!-- Chapter Selection (if not from chapter) -->
                    @if(!$chapter)
                        <div class="mb-6">
                            ...
                            <select name="chapter_id" 
                                ...
                                <!-- Chapters will be loaded via JavaScript based on course selection -->
                            </select>
                        </div>
                    @endif
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('minimum_passing_score', 70) }}"
                               min="0"
                               max="100"
                               required
                               class="w-full rounded-lg border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="space-y-4">
                            <label class="flex items-start cursor-pointer">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('is_required_for_progression') ? 'checked' : '' }}
                            ...
                            <label class="flex items-start cursor-pointer">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('auto_complete_on_pass', true) ? 'checked' : '' }}
                                       class="mt-1 w-5 h-5 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                <div class="ml-3">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                            ...
                            Buat Quiz & Tambahkan Pertanyaan
                        </button>
                    </div>
                </form>
            </div>
